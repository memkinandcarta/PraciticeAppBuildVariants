    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/memkinandcarta/praciticeappbuildvariants/")
                ...
                developers {
                    developer {
                        id.set("memkinandcarta")
                        name.set("memkinandcarta")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/memkinandcarta/praciticeappbuildvariants.git")
                    developerConnection.set("scm:git:ssh://github.com/memkinandcarta/praciticeappbuildvariants.git")
                    url.set("https://github.com/memkinandcarta/praciticeappbuildvariants/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/memkinandcarta/praciticeappbuildvariants/issues")
                }
            }
        }
    }
